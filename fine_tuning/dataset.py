...
extracted_path = "fine_tuning/sms_spam_collection"
...
if __name__ == "__main__":
    ...
    # train_df.to_csv("fine_tuning/data/train.csv", index=None)
    # validation_df.to_csv("fine_tuning/data/validation.csv", index=None)
    # test_df.to_csv("fine_tuning/data/test.csv", index=None)
